...
exports.like = function (id, callback) {
    ...
    character.update({ _id: id }, { $inc: { likes: 1 } }, function (err, char) {
...
exports.update = function (body, callback) {
    ...
    character.update(body.id, {name: body.char_name, about: body.about, path: body.path}, function (err, char) {

        if (err)
            throw err;

        //finding the character
        character.findOne({ _id: body.id }, function (err, char) {
            if (err)
                throw err;
